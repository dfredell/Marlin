...
#define BABYSTEPPING
  ...
  #define DOUBLECLICK_FOR_Z_BABYSTEPPING  // Double-click on the Status Screen for Z Babystepping.
    ...
    #define DOUBLECLICK_MAX_INTERVAL 400   // Maximum interval between clicks, in milliseconds.
...
#define LIN_ADVANCE
  ...
  #define LIN_ADVANCE_K 0.0 //0.2 was good on 2021-04    // Unit: mm compression per 1mm/s extruder speed
